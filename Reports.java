public class Report {
    ...
    Integer FindHall(String event, String date){
    ...
    Pair <Integer, Integer> FindNumSeats(Integer hall){
   ...
   static int countFreq(String pat, String txt)
   {
    ...
    void ReportFreeSeats(String event, String date){
        ...
        System.out.println("Брой свободни места="+ pair.getKey()*pair.getValue()- num1 - num2);         
